...
var total = netflix + hulu + peacock + youtubePremium + disneyPlus
// console.log (total)
...
// var total = (netflix-7) + (hulu-7) + (peacock-5) + youtubePremium + disneyPlus
// console.log (total)
...
var newTotal = (netflix-7) + (hulu-7) + (peacock-5) + youtubePremium + disneyPlus
